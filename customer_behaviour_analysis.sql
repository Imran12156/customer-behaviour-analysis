...
from customer_details
where discount_applied = 'Yes' and purchase_amount_usd >= (select AVG(purchase_amount_usd) from customer_details)
...
ROUND(AVG(purchase_amount_usd),2) as shipping_cost_avg
from customer_details
